...
public class MainTest {
	...
	public void test() {
		...
		try {
			StickyWebResponse result = sw.get("http://www.sluggy.com", null).setOnline(true).execute();
			Object comicObj = result.asHTML().evaluateXPath("//*[@id='container']/div[2]/div[1]/div[2]/img")[0];
